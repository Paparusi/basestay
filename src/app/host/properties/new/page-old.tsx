...
export default function AddProperty() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Connect Wallet to Add Property</h1>
            <p className="text-gray-600 mb-6">
              Connect your Web3 wallet to list properties on BaseStay and start earning USDC from bookings.
            </p>
            <div className="mb-4">
              <ConnectWallet />
            </div>
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Use the property listing hook - simplified without BST staking
